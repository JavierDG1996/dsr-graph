...
/** \mainpage RoboComp::metrics_agent
 *
 * \section intro_sec Introduction
 *
 * The metrics_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/metrics_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class metrics_agent : public RoboComp::Application
{
public:
	metrics_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::metrics_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::metrics_agent app(prefix, startup_check_flag);
