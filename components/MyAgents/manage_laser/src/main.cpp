...
/** \mainpage RoboComp::manage_laser
 *
 * \section intro_sec Introduction
 *
 * The manage_laser component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/manage_laser --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class manage_laser : public RoboComp::Application
{
public:
	manage_laser (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::manage_laser::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::manage_laser app(prefix, startup_check_flag);
