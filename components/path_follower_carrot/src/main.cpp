...
/** \mainpage RoboComp::path_follower_carrot
 *
 * \section intro_sec Introduction
 *
 * The path_follower_carrot component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/path_follower_carrot --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class path_follower_carrot : public RoboComp::Application
{
public:
	path_follower_carrot (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::path_follower_carrot::initialize()
{
...
int ::path_follower_carrot::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::path_follower_carrot app(prefix, startup_check_flag);
