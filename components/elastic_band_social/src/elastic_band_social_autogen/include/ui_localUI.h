...
public:
    ...
    void setupUi(QWidget *local_guiDlg)
    {
        ...
        ks_slider = new QSlider(groupBox_2);
        ks_slider->setObjectName(QString::fromUtf8("ks_slider"));
        ks_slider->setMaximum(500);
        ks_slider->setValue(40);
        ks_slider->setOrientation(Qt::Horizontal);

        horizontalLayout_3->addWidget(ks_slider);
    ...
    void retranslateUi(QWidget *local_guiDlg)
    {
        ...
        label_3->setText(QApplication::translate("local_guiDlg", "Social forces", nullptr));
