...
from PySide2.QtCore import QRect, QRectF, Qt, QSize, QSizeF, QPointF, QLineF
from PySide2.QtGui import QTransform, QPainter, QPolygonF
...
def readData(directory, id):
    ...
    return persons, polylinesI, polylinesP, polylinesS, experiment
...
def get_avgDist_minDist_maxDist_CP_single(persons, traj, polylinesI, polylinesP, polylinesS):
    ...
    return avgDist_cperson, minDist_cperson, maxDist_cperson, social_cperson, dist_cperson2 
...
def showExperimentsInDirectory(directory):
    ...
    for i in range(1, num_experiments + 1):
        ...
        persons, polylinesI, polylinesP, polylinesS, exp = readData(directory, i)
        ...
        #        polylinesAffHigh)
        avgDist, minDist, maxDist, dists_persons,minDists2  = get_avgDist_minDist_maxDist_CP_single(
                persons, exp, polylinesI, polylinesP, polylinesS)
...
showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato')
showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato')
