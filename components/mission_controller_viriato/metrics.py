...
def readData(directory, id):
    ...
    return persons, objects_centers, objects_shapes, polylinesI, polylinesP, polylinesS, experiment
...
def get_avgDist_minDist_maxDist_CP_single(persons, objects, objects_shapes, traj, polylinesI, polylinesP, polylinesS):
    ...
    polygonI = QtCore.QPolygonF()
    polygonP = QtCore.QPolygonF()
    polygonS = QtCore.QPolygonF()
    ...
    for pI in polylinesI:
        for x in pI:
            polygonI.append(QtCore.QPointF(x[0], x[1]))

    for pP in polylinesP:
        for x in pP:
            polygonP.append(QtCore.QPointF(x[0], x[1]))

    for pS in polylinesS:
        for x in pS:
            polygonS.append(QtCore.QPointF(x[0], x[1]))

    ## Object affordances
    #for pN in polylinesAffNormal:
    #    for x in pN:
    #        polygonAffNormal.append(QtCore.QPointF(x[0], x[1]))

    #for pL in polylinesAffLow:
    #    for x in pL:
    #        polygonAffLow.append(QtCore.QPointF(x[0], x[1]))

    #for pM in polylinesAffMed:
    #    for x in pM:
    #        polygonAffMed.append(QtCore.QPointF(x[0], x[1]))

    #for pM in polylinesAffHigh:
    #    for x in pM:
    #        polygonAffHigh.append(QtCore.QPointF(x[0], x[1]))

    for x in traj:
        if polygonI.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
            social_cperson['intimate'] += 1.
        elif polygonP.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
            social_cperson['personal'] += 1.
        elif polygonS.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
    ...
    #for x in traj:
    #    if polygonAffNormal.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
    #        social_affordance['normal'] += 1.
    #    elif polygonAffLow.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
    #        social_affordance['low'] += 1.
    #    elif polygonAffMed.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
    #        social_affordance['medium'] += 1.
    #    elif polygonAffHigh.containsPoint(QtCore.QPointF(x[0], x[1]), Qt.OddEvenFill):
    ...
    return avgDist_cperson, minDist_cperson, maxDist_cperson, avgDist_shape_obj, minDist_shape_obj, maxDist_shape_obj, social_cperson, dist_cperson2, dist_shape_objects2 
...
def get_CHC(ps):
    ...
    ret2 = []
    for i in range(4, len(deriv_ang) - 4):
...
def showExperimentsInDirectory(directory):
    ...
    for i in range(1, num_experiments + 1):
        ...
        persons, objects, objects_shapes, polylinesI, polylinesP, polylinesS, exp = readData(directory, i)
        ...
        #        polylinesAffHigh)
        avgDist, minDist, maxDist, avgDistObj, minDistObj, maxDistObj, dists_persons,minDists2, minDistObj2  = get_avgDist_minDist_maxDist_CP_single(
                persons, objects, objects_shapes, exp, polylinesI, polylinesP, polylinesS)
...
#showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_METRICS/EXPERIMENTO1')
#showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_METRICS/EXPERIMENTO2')
#showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_METRICS/EXPERIMENTO3')
#showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_METRICS/EXPERIMENTO4')
#showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_METRICS/EXPERIMENTO5')
showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_APARTAMENTO_TV/TERCER EXPERIMENTO/FUERZA SOCIAL 0')
showExperimentsInDirectory('/home/javier/robocomp/components/dsr-graph/components/mission_controller_viriato/EXPERIMENTOS_APARTAMENTO_TV/TERCER EXPERIMENTO/FUERZA SOCIAL 10')
